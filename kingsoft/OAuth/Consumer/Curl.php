...
use Kingsoft\OAuth\Storage\StorageInterface as StorageInterface;
...
{	
	...
	public function __construct($key, $secret, StorageInterface $storage, $callback = null)
	{
		...
		if(!extension_loaded('curl')){
			throw new \Kingsoft\Exception('The cURL OAuth consumer requires the cURL extension');
		}
...
//			throw new \Kingsoft\Exception($message);
//		}
